-- Insertar datos en la tabla Usuarios (base común) - Sin cambios
...
-- Insertar datos específicos de Clientes con ubicaciones en Santiago
INSERT INTO Clientes (Usuario_ID, Direccion, ubicacion) VALUES
(1, 'Av. Libertador Bernardo O Higgins 1234', ST_SetSRID(ST_MakePoint(-70.6682, -33.4569), 4326)), -- Centro Santiago
(2, 'Calle Maipú 123, Providencia', ST_SetSRID(ST_MakePoint(-70.6345, -33.4372), 4326)), -- Providencia
(3, 'Los Olivos 456, Las Condes', ST_SetSRID(ST_MakePoint(-70.5698, -33.4175), 4326)), -- Las Condes
(4, 'Av. Central 789, La Florida', ST_SetSRID(ST_MakePoint(-70.5932, -33.5227), 4326)), -- La Florida
(5, 'Pje. Las Rosas 321, Ñuñoa', ST_SetSRID(ST_MakePoint(-70.6005, -33.4548), 4326)), -- Ñuñoa
(6, 'Av. San Carlos 1001, Apoquindo', ST_SetSRID(ST_MakePoint(-70.5793, -33.4102), 4326)), -- Apoquindo
(7, 'Pasaje Norte 45, Recoleta', ST_SetSRID(ST_MakePoint(-70.6423, -33.4189), 4326)), -- Recoleta
(8, 'Calle Secundaria 21, Macul', ST_SetSRID(ST_MakePoint(-70.6123, -33.4865), 4326)), -- Macul
(9, 'Calle Principal 88, Santiago Centro', ST_SetSRID(ST_MakePoint(-70.6502, -33.4378), 4326)), -- Santiago Centro
(10, 'El Roble 1123, Vitacura', ST_SetSRID(ST_MakePoint(-70.5756, -33.3934), 4326)); -- Vitacura

-- Insertar datos específicos de Repartidores con ubicaciones iniciales
INSERT INTO Repartidores (Usuario_ID, Tipo_vehiculo, ubicacion) VALUES
(11, 'AUTO', ST_SetSRID(ST_MakePoint(-70.6500, -33.4500), 4326)), -- Centro
(12, 'MOTO', ST_SetSRID(ST_MakePoint(-70.6000, -33.4300), 4326)), -- Providencia
(13, 'BICICLETA', ST_SetSRID(ST_MakePoint(-70.5700, -33.4200), 4326)), -- Las Condes
(14, 'CAMIONETA', ST_SetSRID(ST_MakePoint(-70.5900, -33.5200), 4326)), -- La Florida
(15, 'MOTO', ST_SetSRID(ST_MakePoint(-70.5800, -33.4100), 4326)); -- Vitacura

-- Insertar datos específicos de Administradores - Sin cambios
...
INSERT INTO Farmacias (Nombre, Lugar, ubicacion) VALUES 
...
-- Poblar tabla Calificaciones - Sin cambios
...
-- Insertar datos en la tabla Pedidos_Repartidores - Sin cambios
...
INSERT INTO Zonas_cobertura (nombre, zona) VALUES
...
INSERT INTO Punto_de_entrega (Nombre, Farmacia_ID, ubicacion) VALUES
...
--Cantidad por farmacia:

--Farmacia San Juan: 6 puntos

--Farmacia La Salud: 7 puntos

--Farmacia El Bienestar: 8 puntos

--Farmacia Santa Maria: 7 puntos

--Farmacia Central: 9 puntos (por ser la central)

--Farmacia La Vida: 7 puntos

--Farmacia Salud Usach: 9 puntos (por estar en zona de alta densidad)